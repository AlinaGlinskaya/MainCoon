...
/* harmony import */ var _utils_samsung_hover_fix__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/samsung-hover-fix */ "./js/utils/samsung-hover-fix.js");
/* harmony import */ var _modules_init_cats_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-cats-slider */ "./js/modules/init-cats-slider.js");
/* harmony import */ var _modules_init_team_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-team-slider */ "./js/modules/init-team-slider.js");
...
/* harmony import */ var _modules_accordion_init_accordions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/accordion/init-accordions */ "./js/modules/accordion/init-accordions.js");
...
Object(_utils_samsung_hover_fix__WEBPACK_IMPORTED_MODULE_2__["samsungHoverFix"])(); // Modules
// ---------------------------------

Object(_modules_init_cats_slider__WEBPACK_IMPORTED_MODULE_3__["initCatsSlider"])();
Object(_modules_tabs_init_tabs__WEBPACK_IMPORTED_MODULE_5__["initTabs"])();
Object(_modules_accordion_init_accordions__WEBPACK_IMPORTED_MODULE_6__["initAccordions"])();
Object(_modules_init_team_slider__WEBPACK_IMPORTED_MODULE_4__["initTeamSlider"])();
...
var accordions = document.querySelectorAll('[data-accordion="parent"]');
  ...
  _createClass(Accordions, [{
    ...
    value: function init() {
      ...
      accordions.forEach(function (el) {
        _this.initAccordion(el);
      });
    }
  }, {
    key: "initAccordion",
    value: function initAccordion(accordion) {
      var _this2 = this;

      var accordionButtons = accordion.querySelectorAll('[data-accordion="button"]');
      accordionButtons.forEach(function (btn) {
        btn.addEventListener('click', function (evt) {
          var accordionElement = evt.target.closest('[data-accordion="element"]');

          if (accordionElement.classList.contains('is-active')) {
            _this2.closeAccordion(accordionElement);
          } else {
            _this2.openAccordion(accordionElement);
          }
        });
      });
    }
...
var initAccordions = function initAccordions() {
  var accordions;
  accordions = new _accordion__WEBPACK_IMPORTED_MODULE_0__["Accordions"]();
  accordions.init();
};
...
/***/ "./js/modules/init-cats-slider.js":
/*!****************************************!*\
  !*** ./js/modules/init-cats-slider.js ***!
  \****************************************/
/*! exports provided: initCatsSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCatsSlider", function() { return initCatsSlider; });
var initCatsSlider = function initCatsSlider() {
  var catsSlider = document.querySelectorAll('.cats__swiper-container');
  ...
  catsSlider.forEach(function (slider) {
    initSwiper(slider);
  });
};
...
var initReviewsSlider = function initReviewsSlider() {
  var reviewsSlider = document.querySelector('.reviews__swiper-container');
...
var initTeamSlider = function initTeamSlider() {
  var teamSlider = document.querySelector('.team__swiper-container');
...
var controls = document.querySelectorAll('[data-tabs="control"]');
var Tabs = /*#__PURE__*/function () {
  ...
  _createClass(Tabs, [{
    ...
    key: "_returnClosestList",
    value: function _returnClosestList(nodeList, parent) {
      var closestList = [];
    ...
    key: "_returnClosestChild",
    value: function _returnClosestChild(nodeList, parent) {
      var currentChild;
      nodeList.forEach(function (element) {
        var elementParent = element.closest('[data-tabs="parent"]');
    ...
    value: function _returnActiveIndex(tabControlElements) {
      var activeIndex = 0;
      var flag = true;
      tabControlElements.forEach(function (el, index) {
    ...
    value: function _setTabStartState(tabContentElement, tabControlElements, tabElements) {
      var activeIndex = this._returnActiveIndex(tabControlElements);

      var blockHeight = this._returnMaxHeight(tabElements);
    ...
    value: function _initTab(tab) {
      ...
      var tabControlElements = this._returnClosestList(tab.querySelectorAll('[data-tabs="control"]'), tab);

      var tabElements = this._returnClosestList(tab.querySelectorAll('[data-tabs="element"]'), tab);

      this._setTabStartState(tabContentElement, tabControlElements, tabElements);

      controls.forEach(function (control) {
        control.addEventListener('click', _this3._openTab);
      });
      tabElements.forEach(function (element) {
        _this3._resizeObserver().observe(element);
      });
    }
  }, {
    key: "_openTab",
    value: function _openTab(evt) {
      ...
      var tabElements = this._returnClosestList(parentElement.querySelectorAll('[data-tabs="element"]'), parentElement);

      var activeTabElement = this._returnClosestChild(parentElement.querySelectorAll('[data-tabs="element"].is-active'), parentElement);

      var activeControl = this._returnClosestChild(parentElement.querySelectorAll('[data-tabs="control"].is-active'), parentElement);
    ...
    value: function _updateTabHeight() {
      var activeTab = document.querySelector('[data-tabs="element"].is-active');
      var parentElement = activeTab.closest('[data-tabs="parent"]');

      var contentElement = this._returnClosestChild(parentElement.querySelectorAll('[data-tabs="content"]'), parentElement);
...
/***/ "./js/utils/samsung-hover-fix.js":
/*!***************************************!*\
  !*** ./js/utils/samsung-hover-fix.js ***!
  \***************************************/
/*! exports provided: samsungHoverFix */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "samsungHoverFix", function() { return samsungHoverFix; });
...
var samsungHoverFix = function samsungHoverFix() {
