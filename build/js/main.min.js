...
var tabs = document.querySelector('[data-tabs="parent"]');
...
var Tabs = /*#__PURE__*/function () {
  ...
  _createClass(Tabs, [{
    ...
    value: function init() {
      ...
      var tabsControls = tabs.querySelector('[data-tabs="controls"]');
      tabsControls.addEventListener('click', this._openTab.bind(this));
    }
  }, {
    key: "_setTabInitialState",
    value: function _setTabInitialState() {
      var tabsItems = tabs.querySelectorAll('[data-tabs="item"]');
      var tabsContent = tabs.querySelector('[data-tabs="content"]');

      var blockHeight = this._returnMaxHeight(tabsItems);

      tabsContent.style.height = "".concat(blockHeight, "px");
    }
  }, {
    key: "_returnMaxHeight",
    value: function _returnMaxHeight(tabItems) {
      var height = [];
    ...
    value: function _openTab(evt) {
      ...
      var activeIndex = evt.target.dataset.index;
      var activeTab = tabs.querySelector('[data-tabs="item"].is-active');
      var tabToOpen = tabs.querySelector("[data-tabs=\"item\"][data-index=\"".concat(activeIndex, "\"]"));
